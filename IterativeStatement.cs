...
public class IterativeStatement
{
    ...
    public void CalculatePiUsingLeibnizFormula()
    {
        ...
        Console.WriteLine("From the given Leibniz formula, assuming the number 100 as infinity, the value of pi is: " +
                          pi);
    }
    ...
    {
        Console.WriteLine(
            "Possible ways to withdraw 10 zloty in coins of denominations 1 zloty, 2 zloty, and 5 zloty:");
        for (int m5 = 0; m5 <= 2; m5++)
        {
            for (int m2 = 0; m2 <= 5; m2++)
            {
                for (int m1 = 0; m1 <= 10; m1++)
                {
                    ...
                    {
                        Console.WriteLine(
                            "Way to withdraw 10 zloty in coins: {0} x 5 zloty + {1} x 2 zloty + {2} x 1 zloty", m5, m2,
                            m1);
                    }
                }
            }
    ...
    public void DrawPatternWithSquaresAndDiagonals()
    {
        int bigSquare = 10;
        int smallSquare = 4;
        int outset = (bigSquare - smallSquare) / 2;

        for (int g = 0; g < bigSquare; g++)
        {
            for (int h = 0; h < bigSquare; h++)
            {
                if (g >= outset && g < outset + smallSquare && h >= outset && h < outset + smallSquare)
                {
                    Console.Write(" * ");
                }
                else if (g == h || g == bigSquare - h - 1)
                {
                    Console.Write(" * ");
                }
                else
